    ...
    "keywords": {
        "SE": (_brands_and_labels()
               ...
               + _categories({
                   ...
                   "outerwear": ["regnkläder barn", "vinteroverall", "skalkläder barn"],
                   ...
                   "wheels":    ["balanscykel", "barncykel", "sparkcykel barn"],
        ...
        "NO": (_brands_and_labels()
               ...
               + _categories({
                   ...
                   "outerwear": ["regntøy barn", "vinterdress barn", "skalldress barn"],
                   ...
                   "wheels":    ["balansesykkel", "barnesykkel", "sparkesykkel barn"],
        ...
        "DK": (_brands_and_labels()
               ...
               + _categories({
                   ...
                   "outerwear": ["regntøj børn", "flyverdragt", "skaljakke børn"],
                   ...
                   "wheels":    ["løbecykel", "børnecykel", "løbehjul"],
        ...
        "FI": (_brands_and_labels()
               ...
               + _categories({
                   ...
                   "outerwear": ["lasten sadehaalari", "lasten talvihaalari",
                                 "lasten kuoritakki"],
                   ...
                   "wheels":    ["potkupyörä", "lasten polkupyörä", "potkulauta"],

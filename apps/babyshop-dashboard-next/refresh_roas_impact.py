...
def _credentials():
    ...
    a RefreshError partway through. Matters here because _bq() memoises its
    client for the whole run. See voyado_sync._credentials for the full write-up.
    """
    try:
        import google.auth
...
def _bq():
    ...
    if _bq_client is None:
        ...
        _bq_client = bigquery.Client(project=BQ_PROJECT, credentials=_credentials())
    return _bq_client
